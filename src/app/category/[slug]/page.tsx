...
export default function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
	...
	const filteredProducts = products.filter(product => {
		if (filters.min_price && product.price < parseFloat(filters.min_price)) return false;
		if (filters.max_price && product.price > parseFloat(filters.max_price)) return false;
		return true;
	});
