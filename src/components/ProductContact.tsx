...
export default function ProductContact({ productName, productSlug }: ProductContactProps) {
  ...
  return (
    <div className="mt-6 pt-6 border-t border-gray-200">
      ...
      <div className="flex gap-3">
        <a
          href={`https://wa.me/40741302753?text=Hello I am interested in ${productName}. Product URL: ${origin}/product/${productSlug}`}
          target="_blank"
