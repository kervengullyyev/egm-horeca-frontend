			...
			<div className="relative overflow-hidden rounded-[24px] border border-black/10 bg-gray-100">
				<div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 py-8 sm:py-12 sm:px-8 lg:grid-cols-2">
					...
					<div className="max-w-xl">
						...
						<div className="mt-6">
							<button className="inline-flex items-center justify-center rounded-md border border-black px-5 py-2 text-sm font-semibold text-foreground transition-colors hover:bg-primary hover:text-primary-foreground">
								SHOP NOW
							</button>
						</div>
					</div>
